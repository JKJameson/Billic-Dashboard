...
<div id="results"></div>
		...
		/*
		          echo '<submodule data-row="1" data-col="1" data-sizex="1" data-sizey="1" style="background:red">';
		          echo 'Test';
		          echo '</submodule>';
		          echo '<submodule data-row="1" data-col="2" data-sizex="1" data-sizey="1" style="background:blue">';
		          echo 'Test';
		          echo '</submodule>';
		          echo '<submodule data-row="1" data-col="3" data-sizex="1" data-sizey="1" style="background:green">';
		          echo 'Test';
		          echo '</submodule>';
		*/
		$row = 1;
